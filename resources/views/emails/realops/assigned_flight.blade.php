...
<p>This is an automated email to inform you that you have been assigned to Realops flight {{ $flight->flight_number }}. Please review the information below for your flight information and you can also view the latest information on the <a hret="https://www.vhcf.net/realops">Realops Dashboard</a>. Honolulu gate information and much more can be found in the <a hret="https://www.vhcf.net/pilots/guide/hnl">HNL Pilot Guide</a>.</p>
