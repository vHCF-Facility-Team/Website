                        ...
                        <tbody>
                            @foreach($appointments as $appointment)
                                <tr>
                                    ...
                                    <td scope="col"><a href="https://scheddy.vhcf.net/schedule/?sessionId={{ $appointment->session->id }}&reschedule=true&type={{ $appointment->sessionType->id }}" target="_blank" class="btn btn-primary simple-tooltip" data-bs-toggle="tooltip" title="View"><i class="fas fa-edit fa-fw"></i></a></td> 
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
            ...
            @csrf
                ...
                <div class="row-mb-3">
                    ...
                    @toggle('discord_role_updater')
                        ...
                        @else
                            <div class="col-4">
                                <a href="#" data-bs-toggle="tooltip" title="No Discord ID Found: Ensure your Discord ID is linked to your VATUSA account. The roster may take time to refresh. You can manually update your role in the HCF Discord server in the meantime." class="btn btn-secondary" type="button">Update Discord Role</a>
                            </div>
                        @endif
                    @endtoggle
                </div>
