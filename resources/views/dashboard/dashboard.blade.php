...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <a class="btn btn-secondary w-100 mb-2" href="https://scheddy.vhcf.net/" target="_blank">Schedule a Training Session</a></br>
            @if(Auth::user()->isAbleTo('staff'))
                <a class="btn btn-secondary w-100 mb-2" href="http://mail.google.com" target="_blank">Email</a>
            @endif
