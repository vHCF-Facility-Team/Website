...
@include('inc.header', ['title' => 'HCF Pilot Passport Challenge', 'type' => 'external', 'content' => '<a href="/pilot_passport/login" class="btn btn-primary float-end" dusk="login">Login as Pilot</a>'])
@else
@include('inc.header', ['title' => 'HCF Pilot Passport Challenge', 'type' => 'external', 'content' => '<button disabled class="btn btn-primary float-end">Welcome, ' . auth()->guard('realops')->user()->full_name . '</button>'])
@endif
