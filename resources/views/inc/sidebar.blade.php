<div class="accordion" id="pill-sidebar">
    <div class="accordion-item">
        <h2 class="accordion-header collapsible-sidebar" id="controllersClickable" name="controllers">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-target="#collapseControllers" aria-expanded="false" aria-controls="collapseControllers">
                HCF CONTROLLERS
            </button>
        </h2>
        <div id="collapseControllers" class="accordion-collapse collapse" data-bs-parent="#pill-sidebar">
    ...
    <div class="accordion-item">
        <h2 class="accordion-header collapsible-sidebar">
    ...
    <div class="accordion-item">
        ...
        <div id="collapseAdministration" class="accordion-collapse collapse" data-bs-parent="#pill-sidebar">
            <div class="accordion-body">
                <div class="nav flex-column nav-pills pt-0">
...
<div class="card">
    <div class="card-body p-2">
        ...
        <table class="table table-sm table-borderless table-striped pb-0 mb-0">
            ...
            @foreach($home as $h)
            <tr class="p-3 m-0">
                <td class="py-0 ps-1 pe-2 m-0"><strong>{{ $h->full_name }}</strong></td>
                <td class="py-0 px-2 m-0">&nbsp;{{ $stats[$h->id]->bronze_hrs }}</td>
            </tr>
            @endforeach
            @else
            <tr class="p-3 m-0">
                <td class="py-0 ps-1 pe-2 m-0"><i>So empty...</i></td>
            </tr>
            @endif
        </table>
    </div>
...
<div class="card">
    <div class="card-body p-2">
        ...
        <table class="table table-sm table-borderless table-striped pb-0 mb-0">
            ...
            <tr class="p-3 m-0">
                <td class="py-0 ps-1 pe-2 m-0"><strong>{{ $t->title }}</strong></td>
                <td class="py-0 px-2 m-0">&nbsp;{{ $t->metric }}</td>
            </tr>
            @endforeach
            @else
            <tr class="p-3 m-0">
                <td class="py-0 ps-1 pe-2 m-0"><i>Unavailable</i></td>
            </tr>
            @endif
        </table>
    </div>
...
<div class="card">
    <div class="card-body p-2">
        ...
        <table class="table table-sm table-borderless table-striped pb-0 mb-0">
            ...
            <tr class="p-3 m-0">
                <td class="py-0 ps-1 pe-2 m-0"><strong>{{ $m->name }}</strong></td>
...
<div class="card">
    <div class="card-body p-2">
        ...
        <table class="table table-sm table-borderless table-striped pb-0 mb-0">
            ...
            <tr class="p-3 m-0">
                <td class="py-0 ps-1 pe-2 m-0"><strong>{{ $c->name }}</strong></td>
